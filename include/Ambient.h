...
class Ambient : public Light
{
  public:
	Ambient()
	    : Light(Type::AMBIENT), ls_(1.0f), color_(1.0f, 1.0f, 1.0f) {}
	explicit Ambient(float ls)
	    : Light(Type::AMBIENT), ls_(ls), color_(1.0f, 1.0f, 1.0f) {}
	explicit Ambient(const RGBColor &color)
	    : Light(Type::AMBIENT), ls_(1.0f), color_(color) {}
	Ambient(float r, float g, float b)
	    : Light(Type::AMBIENT), ls_(1.0f), color_(r, g, b) {}
